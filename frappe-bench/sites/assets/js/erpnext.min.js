...
erpnext.taxes_and_totals = erpnext.payments.extend({
	...
	set_cumulative_total: function set_cumulative_total(row_idx, tax) {
		if (row_idx == 0) {
			tax.total = flt(this.frm.doc.net_total + tax.tax_amount_after_discount_amount, precision("total", tax));
		} else {
			tax.total = flt(this.frm.doc["taxes"][row_idx - 1].total + tax.tax_amount_after_discount_amount, precision("total", tax));
		}
	},
